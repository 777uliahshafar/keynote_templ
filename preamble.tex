...
% Change background single frame (canvas)
\newcommand{\bca}{\setbeamercolor{background canvas}{bg=digiPH_ocean!90}}
\newcommand{\bcb}{\setbeamercolor{background canvas}{bg=digiPH_leaf!90}}
\newcommand{\bcc}{\setbeamercolor{background canvas}{bg=digiPH_stem!90}}


% white body foreground
\newcommand{\bodyw}{\setbeamercolor{normal text}{fg=white}\usebeamercolor*{normal text}}

% white frametitle foreground
\newcommand{\frametitlew}[1]{\frametitle{\textcolor{white}{#1}}}

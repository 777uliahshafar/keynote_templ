...
\newcommand{\bfa}{\setbeamercolor{background canvas}{bg=digiPH_ocean!90}}
\newcommand{\bfb}{\setbeamercolor{background canvas}{bg=digiPH_leaf!90}}
\newcommand{\bfc}{\setbeamercolor{background canvas}{bg=digiPH_stem!90}}
